            ...
            <div class="card-body">
               <form id="login-form" action="{{ route('registration.post') }}" method="post">
                  ...
                  <div class="input-group mb-3">
                     ...
                     <input type="name" class="form-control" placeholder="Name" id="name" name="name" value='{{ old('name') }}' required="" />
                  </div>
                  <div class="input-group mb-3">
                     <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <p class="mb-0">
                  <a href="{{ route('login') }}" class="text-center">Login for existing user</a>
                </p>
            </div>
            <!-- /.card-body -->
         </div>
